...
class SnakeGame:
    # Initializes SnakeGame object with pre-initialized objects and
...
self.snake.update()
# If snake hits a food block, then consume the food, add new food and grow
# the snake
...
pygame.draw.rect(self.screen, SNAKE_COLOR, (blockWidth * (px - 1),
                                            blockHeight * (py - 1), blockWidth, blockHeight))
# Draw food objects
for (fx, fy) in self.food:
pygame.draw.rect(self.screen, FOOD_COLOR, (blockWidth * (fx - 1),
                                           blockHeight * (fy - 1), blockWidth, blockHeight))
pygame.display.flip()
...
self.screen.blit(self.font.render(
    "Game over! Press Space to start a new game", 1, (255, 255, 255)), (20, 150))
self.screen.blit(self.font.render("Your score is: %d" %
                                  self.score, 1, (255, 255, 255)), (140, 180))
pygame.display.flip()
